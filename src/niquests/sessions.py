...
class Session:
    ...
    def __init__(
        ...
        *,
        ...
        disable_http1: bool = os.environ.get("NIQUESTS_DISABLE_HTTP1", "0") != "0",
        disable_http2: bool = os.environ.get("NIQUESTS_DISABLE_HTTP2", "0") != "0",
        disable_http3: bool = os.environ.get("NIQUESTS_DISABLE_HTTP3", "0") != "0",

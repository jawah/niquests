...
class Middleware(ABC):
    ...
    def pre_request(self, request: PreparedRequest, *args: Any, **kwargs: Any) -> None:
        """Called before the request is sent."""

    def pre_send(self, request: PreparedRequest, *args: Any, **kwargs: Any) -> None:
    ...
    def early_response(self, response: Response, *args: Any, **kwargs: Any) -> None:
    ...
    def response(self, response: Response, *args: Any, **kwargs: Any) -> None:
...
class AsyncMiddleware(ABC):
    ...
    async def pre_request(self, request: PreparedRequest, *args: Any, **kwargs: Any) -> None:
        """Called before the request is sent."""

    async def pre_send(self, request: PreparedRequest, *args: Any, **kwargs: Any) -> None:
        """The prepared request got his ConnectionInfo injected.
        This event is triggered just after picking a live connection from the pool"""

    async def on_upload(self, request: PreparedRequest, *args: Any, **kwargs: Any) -> None:
        """Permit to monitor the upload progress of passed body.
        This event is triggered each time a block of data is transmitted to the remote peer.
        Use this hook carefully as it may impact the overall performance."""

    async def early_response(self, response: Response, *args: Any, **kwargs: Any) -> None:
        """An early response caught before receiving the final Response for a given Request. Like but not limited to 103 Early Hints.
        This event is triggered before the Response is returned to the user."""

    async def response(self, response: Response, *args: Any, **kwargs: Any) -> None:
        """Called when a response is received."""
